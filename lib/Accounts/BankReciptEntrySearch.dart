...
class BankReceiptEntrySearch extends StatefulWidget {
  BankReceiptEntrySearch({Key? key}) : super(key: key);

  @override
  State<BankReceiptEntrySearch> createState() => _BankReceiptEntrySearchState();
}

class _BankReceiptEntrySearchState extends State<BankReceiptEntrySearch> {
  bool _val = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
          child: Column(
        children: [
          cAppBar(ctitle: "Bank Receipt Entry Search"),
          SearchRow(),
          SizedBox(
            height: 150,
          ),
