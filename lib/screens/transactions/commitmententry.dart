...
class CommitmentEntry extends StatefulWidget {
  const CommitmentEntry({Key? key}) : super(key: key);

  @override
  State<CommitmentEntry> createState() => _CommitmentEntryState();
}

class _CommitmentEntryState extends State<CommitmentEntry> {
                        ...
                        children: [
                          ...
                          Container(
                              child: Column(
                                children: [
                                  Text(''),
                                  TtextField(text: "Auct Date", w: 140),
                                ],
                              )
                          ),
                          Spacer(),
                          Container(
                              child: Column(
                                children: [
                                  Text(''),
                                  TtextField(text: "Group No", w: 140),
                                ],
                              )
                          ),
                          Spacer(),
                          Container(
                              child: Column(
                                children: [
                                  Text(''),
                                  TtextField(text: "Due Date", w: 140),
                                ],
                              )
                          ),
                          Spacer(),
