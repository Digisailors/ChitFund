...
class OkBankReceiptES extends StatefulWidget {
  OkBankReceiptES({Key? key}) : super(key: key);

  @override
  State<OkBankReceiptES> createState() => _OkPaymentEntryState();
}

class _OkPaymentEntryState extends State<OkBankReceiptES> {
