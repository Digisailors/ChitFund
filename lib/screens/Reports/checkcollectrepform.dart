...
class CheckCollectionReportForm extends StatefulWidget {
  const CheckCollectionReportForm({Key? key}) : super(key: key);

  @override
  State<CheckCollectionReportForm> createState() => _CheckCollectionReportFormState();
}

class _CheckCollectionReportFormState extends State<CheckCollectionReportForm> {
  @override
                ...
                Column(
                  children: [
                    ...
                    Row(
                      children: [
                        Spacer(),
                        TtextField(text: "Group No(select)",w: 190),
                        SizedBox(
                          width: 10,
                        ),
