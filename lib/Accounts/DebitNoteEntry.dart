...
class DebitNoteEntry extends StatefulWidget {
  DebitNoteEntry({Key? key}) : super(key: key);

  @override
  State<DebitNoteEntry> createState() => _DebitNoteEntryState();
}

class _DebitNoteEntryState extends State<DebitNoteEntry> {
  @override
  bool _val = false;
          ...
          Expanded(
            child: Scaffold(
              body: Container(
                ...
                child: Column(
                  children: [
                    cAppBar(ctitle: "Debit Note Entry"),
                    hspacer(),
                    SearchRow(),
                    SizedBox(
                      height: 60,
