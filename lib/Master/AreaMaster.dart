...
class AreaMaster extends StatefulWidget {
  AreaMaster({Key? key}) : super(key: key);
...
class _AreaMasterState extends State<AreaMaster> {
  ...
  List<Widget> _getTitleWidget() {
    return [
      ...
      _getTitleItemWidget('Code', 240),
      _getTitleItemWidget('Area', 880),
    ];
  }
  ...
  Widget _generateRightHandSideColumnRow(BuildContext context, int index) {
    return Row(
      children: <Widget>[
        ...
        ColumnCellTable(text: 'hello', w: 880, h: 52),
      ],
    );
  }
