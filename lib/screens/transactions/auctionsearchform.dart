...
class AuctionSearchForm extends StatefulWidget {
  const AuctionSearchForm({Key? key}) : super(key: key);

  @override
  State<AuctionSearchForm> createState() => _AuctionSearchFormState();
}

class _AuctionSearchFormState extends State<AuctionSearchForm> {
  @override
                ...
                Column(
                  children: [
                    ...
                    Row(
                      children: [
                        Spacer(),
                        TtextField(text: "Auct Date", w: 190),
                        SizedBox(width: 10,),
                    ...
                    Row(
                      children: [
                        Spacer(),
                        TtextField(text: "Due Date", w: 190),
                        SizedBox(width: 10,),
                        TtextField(text: "To", w: 190),
                        Spacer(),
                      ],
