...
class ReceiptEntrySearch extends StatefulWidget {
  ReceiptEntrySearch({Key? key}) : super(key: key);

  @override
  State<ReceiptEntrySearch> createState() => _ReceiptEntrySearchState();
}

class _ReceiptEntrySearchState extends State<ReceiptEntrySearch> {
  bool _val = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
          child: Column(
        children: [
          cAppBar(ctitle: "Receipt Entry Search"),
          SearchRow(),
          SizedBox(
            height: 150,
          ),
