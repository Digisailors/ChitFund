...
class OkReceiptES extends StatefulWidget {
  OkReceiptES({Key? key}) : super(key: key);

  @override
  State<OkReceiptES> createState() => _OkReceiptESState();
}

class _OkReceiptESState extends State<OkReceiptES> {
