...
class PaymentEntrySearch extends StatefulWidget {
  PaymentEntrySearch({Key? key}) : super(key: key);

  @override
  State<PaymentEntrySearch> createState() => _PaymentEntrySearchState();
}

class _PaymentEntrySearchState extends State<PaymentEntrySearch> {
  bool _val = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
          child: Column(
        children: [
          cAppBar(ctitle: "Credit Note Entry Search"),
          SearchRow(),
          SizedBox(
            height: 150,
          ),
