...
class BankPaymentEntrySearch extends StatefulWidget {
  BankPaymentEntrySearch({Key? key}) : super(key: key);

  @override
  State<BankPaymentEntrySearch> createState() => _BankPaymentEntrySearchState();
}

class _BankPaymentEntrySearchState extends State<BankPaymentEntrySearch> {
  bool _val = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
          child: Column(
        children: [
          cAppBar(ctitle: "Bank Payment Entry Search"),
          SearchRow(),
          SizedBox(
            height: 150,
          ),
