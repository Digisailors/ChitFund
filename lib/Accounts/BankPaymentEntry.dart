...
class BankPaymentEntry extends StatefulWidget {
  BankPaymentEntry({Key? key}) : super(key: key);

  @override
  State<BankPaymentEntry> createState() => _BankPaymentEntryState();
}

class _BankPaymentEntryState extends State<BankPaymentEntry> {
  @override
  bool _val = false;
          ...
          Expanded(
            child: Scaffold(
              body: Container(
                ...
                child: Column(
                  children: [
                    cAppBar(ctitle: "Bank Payment Entry"),
                    hspacer(),
                    SearchRow(),
                    SizedBox(
                      height: 60,
