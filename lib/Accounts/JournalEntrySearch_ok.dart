...
class OkJournalEntry extends StatefulWidget {
  OkJournalEntry({Key? key}) : super(key: key);

  @override
  State<OkJournalEntry> createState() => _OkJournalEntryState();
}

class _OkJournalEntryState extends State<OkJournalEntry> {
