...
class CreditNoteEntry extends StatefulWidget {
  CreditNoteEntry({Key? key}) : super(key: key);

  @override
  State<CreditNoteEntry> createState() => _CreditNoteEntryState();
}

class _CreditNoteEntryState extends State<CreditNoteEntry> {
  @override
  bool _val = false;
          ...
          Expanded(
            child: Scaffold(
              body: Container(
                ...
                child: Column(
                  children: [
                    cAppBar(ctitle: "Credit Note Entry"),
                    hspacer(),
                    SearchRow(),
                    SizedBox(
                      height: 60,
