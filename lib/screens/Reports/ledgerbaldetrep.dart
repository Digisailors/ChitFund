...
class LedgerBalanceDetailReport extends StatefulWidget {
  const LedgerBalanceDetailReport({Key? key}) : super(key: key);

  @override
  State<LedgerBalanceDetailReport> createState() => _LedgerBalanceDetailReportState();
}

class _LedgerBalanceDetailReportState extends State<LedgerBalanceDetailReport> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          cAppBar(ctitle: "Ledger Balance Detail Report", acc: "User 1"),
          Container(
  ...
  List<Widget> _getTitleWidget() {
    return [
      ...
      _getTitleItemWidget('Ledger', 250),
      _getTitleItemWidget('Vch. Type', 130),
      _getTitleItemWidget('Ref. No', 130),
      _getTitleItemWidget('V. No', 130),
      _getTitleItemWidget('Debit', 130),
      _getTitleItemWidget('Credit', 130),
      _getTitleItemWidget('Close Bal', 150),
    ];
  }
