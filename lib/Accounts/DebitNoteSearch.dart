...
class DebitNoteEntrySearch extends StatefulWidget {
  DebitNoteEntrySearch({Key? key}) : super(key: key);

  @override
  State<DebitNoteEntrySearch> createState() => _DebitNoteEntrySearchState();
}

class _DebitNoteEntrySearchState extends State<DebitNoteEntrySearch> {
  bool _val = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
          child: Column(
        children: [
          cAppBar(ctitle: "Debit Note Entry Search"),
          SearchRow(),
          SizedBox(
            height: 150,
          ),
