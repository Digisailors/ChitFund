...
class BankReceiptEntry extends StatefulWidget {
  BankReceiptEntry({Key? key}) : super(key: key);

  @override
  State<BankReceiptEntry> createState() => _BankReceiptEntryState();
}

class _BankReceiptEntryState extends State<BankReceiptEntry> {
  @override
  bool _val = false;
          ...
          Expanded(
            child: Scaffold(
              body: Container(
                ...
                child: Column(
                  children: [
                    cAppBar(ctitle: "Bank Receipt Entry"),
                    hspacer(),
                    SearchRow(),
                    SizedBox(
                      height: 60,
                    ...
                    Row(
                      children: [
                        ...
                        wspacer(),
                        azTextfld(
                            width: 200, title: "Date", controller: controller),
                      ],
                    ),
                    SizedBox(
                      height: 120,
